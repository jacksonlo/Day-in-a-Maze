...
public class Block {
	...
	public Block(GameObject blockType, int x, int y, int z) {
		...
		_width = this.blockType.transform.lossyScale.x;

		this.blockType = GameObject.Instantiate (this.blockType, new Vector3(x * _width, y * _width, z * _width), Quaternion.identity) as GameObject;
	}
	...
	public Block(GameObject blockType, GameObject parent, int x, int y, int z) {
		...
		this.blockType = GameObject.Instantiate (this.blockType, new Vector3(x * _width, y * _width, z * _width), Quaternion.identity) as GameObject;
		this.blockType.transform.parent = parent.transform;
	}
